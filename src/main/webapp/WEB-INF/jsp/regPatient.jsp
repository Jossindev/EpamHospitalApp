...
<div class="row">
    <div class="col m6 offset-m3 l4 offset-l4 s12">
           <div class="card-panel z-depth-5" style="min-height: 90vh; margin-top: 4vh; position: relative">
            <form method="post" action=${pageContext.request.contextPath}/admin/registerPatient class="center-block" style="text-align: center; min-width: 80%">
             ...
             <div class="input-field ">
                 ...
                 <label class="active" for="patientId"><fmt:message key="patients"/></label>
             </div>
